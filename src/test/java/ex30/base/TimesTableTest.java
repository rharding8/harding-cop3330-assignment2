...
class TimesTableTest {
  ...
  @Test
  void makeTable_small() {
    TimesTable multi = new TimesTable();
    int[][] expected = {{1, 2, 3}, {2, 4, 6}, {3, 6, 9}};
    int[][] actual = multi.makeTable(3);

    assertArrayEquals(expected, actual);
  }

  @Test
  void makeTable_medium() {
    TimesTable multi = new TimesTable();
    int[][] expected = {
            {1, 2, 3, 4, 5}, {2, 4, 6, 8, 10}, {3, 6, 9, 12, 15}, {4, 8, 12, 16, 20}, {5, 10, 15, 20, 25}
    };
    int[][] actual = multi.makeTable(5);

    assertArrayEquals(expected, actual);
  }

  @Test
  void makeTable_large() {
    TimesTable multi = new TimesTable();
    int[][] expected = {
            {1, 2, 3, 4, 5, 6, 7}, {2, 4, 6, 8, 10, 12, 14}, {3, 6, 9, 12, 15, 18, 21},
            {4, 8, 12, 16, 20, 24, 28}, {5, 10, 15, 20, 25, 30, 35}, {6, 12, 18, 24, 30, 36, 42},
            {7, 14, 21, 28, 35, 42, 49}
    };
    int[][] actual = multi.makeTable(7);

    assertArrayEquals(expected, actual);
  }

  @Test
  void makeTable_very_large() {
    TimesTable multi = new TimesTable();
    int[][] expected = {
            ...
            {13, 26, 39, 52, 65, 78, 91, 104, 117, 130, 143, 156, 169, 182, 195}, {14, 28, 42, 56, 70, 84, 98, 112, 126, 140, 154, 168, 182, 196, 210},
            {15, 30, 45, 60, 75, 90, 105, 120, 135, 150, 165, 180, 195, 210, 225}
    };
    int[][] actual = multi.makeTable(15);
